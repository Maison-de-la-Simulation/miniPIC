...
public:
  ...
  void allocate(Params &params, Backend &backend) {
    ...
    DEBUG("End patch allocation");

    // Momentum correction (to respect the leap frog scheme)
    DEBUG("Start momentum correction");
    ...
    DEBUG("End momentum correction");

    // For each species, print :
    // - total number of particles
    DEBUG("Start particles information");
    ...
    DEBUG("End particles information");

    // Checksum for field
    DEBUG("Start checksum for fields");
    ...
    DEBUG("End checksum for fields");

    // Checksum for particles
    DEBUG("Start checksum for particles");
    ...
    DEBUG("End checksum for particles");
